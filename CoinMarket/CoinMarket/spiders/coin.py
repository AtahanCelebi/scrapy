...
#without cloudflare-middleware it gives 429 unknown status we only crawler 61 coins from 100 coins
# import and changed the status here. Right click to "CloudFlareMiddleware" 
...
class CoinSpider(CrawlSpider):
    ...
    #takes href attribute and go pages to crawl
    rules = (
    ...
    def parse_item(self, response):
        yield{
            ...
            'URL':response.url #the url we come from
        }
